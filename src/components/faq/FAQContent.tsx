  ...
  return (
    <div className="border-b border-black/5 last:border-none">
      ...
      >
        ...
        <div className={`w-8 h-8 flex items-center justify-center border border-black/10 transition-all duration-500 ${isOpen ? 'bg-[#ed1c24] border-[#ed1c24] text-white rotate-180' : 'group-hover:border-black'}`}>
          <ChevronDown size={16} />
        </div>
      </button>
      <AnimatePresence>
    ...
    <div className="bg-white pt-40 pb-32 px-10 min-h-screen">
      <div className="max-w-[1000px] mx-auto">
        <header className="mb-24">
          ...
          >
            <HelpCircle size={14} />
            <span className="text-[10px] font-black tracking-[0.5em] uppercase italic">Knowledge Base</span>
          </motion.div>
